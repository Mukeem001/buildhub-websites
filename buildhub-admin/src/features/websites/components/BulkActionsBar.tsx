...
const BulkActionsBar = ({
  ...
  return (
    <div className="mb-6 flex flex-col gap-4 rounded-2xl border border-blue-500/20 bg-blue-500/5 p-5 lg:flex-row lg:items-center lg:justify-between">

      <div>
        <h3 className="text-lg font-semibold text-white">
          {selectedCount} Website
          {selectedCount > 1 ? "s" : ""} Selected
        </h3>

        <p className="mt-1 text-sm text-zinc-400">
          Perform actions on selected websites.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          onClick={onPublish}
          className="flex items-center gap-2 rounded-xl bg-green-600 px-5 py-3 font-medium text-white transition hover:bg-green-500"
        >
