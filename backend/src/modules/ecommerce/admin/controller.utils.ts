...
import type { EcommerceAdminRequest } from "./types";

export type { EcommerceAdminRequest, EcommerceAdminControllerHandler } from "./types";
...
export const sendContext = (req: EcommerceAdminRequest, data: any) => ({
  success: true,
  website: {
