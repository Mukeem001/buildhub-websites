...
import systemTemplatesRoutes from "./routes/system-templates.routes";
...
import allowOriginRoutes from "./routes/allowOrigin.routes";
...
app.use("/api/admin/allow-origins", allowOriginRoutes);
